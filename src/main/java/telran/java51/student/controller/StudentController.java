...
public class StudentController {
	...
	@PostMapping("/student")
	public Boolean addSudent(@RequestBody StudentCreateDto studentCreateDto) {
	...
	public List<StudentDto> getStdentsByExamMinScore(@PathVariable("exam") String examName,
			@PathVariable Integer minScore) {

		return studentService.getStudentsByExamMinScore(examName, minScore);
	}
